...
public class ColorHexa{
    ...
    public ColorHexa(MainGLRenderer renderer) {
        ...
        buffer = ByteBuffer.allocateDirect(hexaIndex.length *2);//2Byte short size
        buffer.order(ByteOrder.nativeOrder());
        indexBuffer = buffer.asShortBuffer();
        indexBuffer.put(hexaIndex);
    ...
    public void draw(float[] mtxProj, float[] mtxView) {
        ...
        GLES20.glDrawElements(GLES20.GL_TRIANGLES, hexaIndex.length, GLES20.GL_UNSIGNED_SHORT
